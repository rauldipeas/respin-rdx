# ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/32x32/apps/ubuntu-tweak.svg) [Respin RDX](https://github.com/rauldipeas/respin-rdx)

This is my personal compilation of the [**Ubuntu**](https://ubuntu.com) [_flavours_](https://ubuntu.com/desktop/flavours).

The system base is [**optimized**](https://github.com/rauldipeas/respin-rdx/blob/main/scripts/enhancements/rtcqs.sh) for multimedia content creation *(audio, video and image)*, based on the checking parameters of the [**rtcqs**](https://codeberg.org/rtcqs/rtcqs).
...
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/devices/audio-card.svg) [**`udev-rtirq`**](https://github.com/jhernberg/udev-rtirq) (high priority rules for audio interface management)
...
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/apps/system-software-install.svg) [**App Grid**](https://www.appgrid.org) (software center)
...
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/apps/distributor-logo-debian.svg) [**`deb-get`**](https://github.com/wimpysworld/deb-get) (3rd party `.deb` package installer through direct download)
...
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/apps/firefox.svg) [**Firefox**](https://support.mozilla.org/pt-BR/kb/instale-o-firefox-no-linux) (internet browser, binary directly from Mozilla website)
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/apps/thunderbird.svg) [**Thunderbird**](https://support.mozilla.org/pt-BR/kb/instalando-o-thunderbird-no-linux) (email client, binary directly from Mozilla website)
* ![](https://raw.githubusercontent.com/PapirusDevelopmentTeam/papirus-icon-theme/master/Papirus/22x22/apps/com.ulduzsoft.Birdtray.svg) [**Birdtray**](https://github.com/gyunaev/birdtray) (tray icon for Thunderbird)
