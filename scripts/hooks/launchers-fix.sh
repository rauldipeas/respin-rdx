...
if test -f /usr/share/applications/iriunwebcam.desktop;then
    sed -i "s|Exec=/usr/local/bin/iriunwebcam|Exec=bash -c 'GTK2_RC_FILES=/usr/share/themes/Orchis-Dark-Compact/gtk-2.0/gtkrc iriunwebcam'|" /usr/share/applications/iriunwebcam.desktop
fi
