...
### Mupen64Plus
bash <(wget -qO- https://github.com/rauldipeas/respin-rdx/raw/main/scripts/mupen64plus-qt.sh)
### PCSX2
...
### Yabause
bash <(wget -qO- https://github.com/rauldipeas/respin-rdx/raw/main/scripts/yabause.sh)
### EmulationStation DE
