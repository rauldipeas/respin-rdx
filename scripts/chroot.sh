...
sudo rm -rf "$CHROOT"/{Adwaita-for-Steam*,betterbird*,cinnamon-transparent-panels*,enhancements*,firefox*,materia-kde*,MangoHud*,Telegram*,udev-rtirq*,*.deb,*.svg,*.tar.gz,*.tar.xz,*.zip}
