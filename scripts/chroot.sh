...
sudo rm -rf "$CHROOT"/{Adwaita-for-Steam*,cinnamon-transparent-panels*,enhancements*,firefox*,materia-kde*,MangoHud*,mitsugen*,Telegram*,thunderbird*,udev-rtirq*,*.deb,*.tar.gz,*.tar.xz,*.zip}
