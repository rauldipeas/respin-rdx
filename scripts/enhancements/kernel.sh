...
wget -q https://kernel.ubuntu.com/~kernel-ppa/mainline/$KERNEL_VER$KERNEL_HEADERS_COMMON_FILE
wget -q https://kernel.ubuntu.com/~kernel-ppa/mainline/$KERNEL_VER$KERNEL_HEADERS_FILE
wget -q https://kernel.ubuntu.com/~kernel-ppa/mainline/$KERNEL_VER$KERNEL_IMAGE_FILE
wget -q https://kernel.ubuntu.com/~kernel-ppa/mainline/$KERNEL_VER$KERNEL_MODULES_FILE
