...
if [ -f /usr/share/xsessions/xubuntu.desktop ]; then
    ...
    wget -qO /usr/share/xfce4-panel-profiles/layouts/Raul\ Dipeas\ -\ Superbar.tar.bz2 https://github.com/rauldipeas/respin-rdx/raw/main/assets/XFCE/rauldipeas-superbar.bz2
