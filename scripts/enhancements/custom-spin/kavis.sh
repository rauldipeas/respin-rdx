...
mv smooth-reaper-theme/Smooth\ 6\ V2.1/3-Theme/Smooth_6_Dark.ReaperTheme /etc/skel/.config/REAPER/Scripts/Cockos/
mv smooth-reaper-theme/Smooth\ 6\ V2.1/3-Theme/Smooth_6_Dark.ReaperTheme /etc/skel/.config/REAPER/Scripts/Cockos/Default_6.0.ReaperThemeZip
