...
find $CHROOT/boot -name "initrd.img-*-rdx" -exec sudo cp {} respin-rdx/image/casper/initrd \;
find $CHROOT/boot -name "vmlinuz-*-rdx" -exec sudo cp {} respin-rdx/image/casper/vmlinuz \;
